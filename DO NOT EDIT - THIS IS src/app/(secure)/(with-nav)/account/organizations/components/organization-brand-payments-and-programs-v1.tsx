...
import { PartnerProgramCredits } from '~/app/(secure)/(with-nav)/account/organizations/components/partner-program-credits.tsx'
import { PaymentTermDefaults } from '~/app/(secure)/(with-nav)/account/organizations/components/payment-term-defaults-v1.tsx'
...
export const OrganizationBrandPaymentsAndPrograms = forwardRef<
  HTMLDivElement,
    ...
    <Surface ref={ref} border padding="6">
      <Surface.Header className="p-4">
        <Heading fontSize="xl" fontWeight="bold" textColor="primary">
          {t(
            'organization-details:internal.payments-and-partner-programs.title.brand'
          )}
        </Heading>
      </Surface.Header>
      <PaymentTermDefaults
