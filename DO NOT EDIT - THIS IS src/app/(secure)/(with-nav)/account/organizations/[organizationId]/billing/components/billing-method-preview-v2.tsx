...
export const BillingMethodPreview = ({
  ...
  const { data: creditCardInfo, isLoading } =
    trpcReactClient.financeCoordinator.getBillingProfileDefaultBillingServiceMethodInfo.useQuery(
      {
        billingProfileId,
      }
    )
  ...
  const handleEditPaymentMethod = () => {
    router.push(
      route(
        '/account/organizations/:organizationId/billing/profiles/:billingProfileId/credit-cards'
      ).params({
        billingProfileId,
