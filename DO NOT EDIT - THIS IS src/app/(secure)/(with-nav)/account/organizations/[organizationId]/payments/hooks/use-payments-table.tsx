...
import type { PaymentStatus } from '@mntn-dev/domain-types'
import type {
...
/**
 * Hook to create and configure the payments history table
 */
...
function usePaymentsTableColumns() {
  ...
  return useMemo(() => {
    return [
      ...
      columnHelper.accessor('status', {
        ...
        cell: (props: CellContext<FlattenedTransaction, PaymentStatus>) => (
        ...
        cell: (props: CellContext<FlattenedTransaction, number>) => (
          <span>
            {props.getValue().toLocaleString('en-US', {
              style: 'currency',
              currency: props.row.original.unit || 'USD',
            })}
          </span>
        ),
        enableSorting: true,
